...
from .resources.volunteers import ns as volunteer_ns
from .resources.fundraising import ns as fundraising_ns
...
def create_app():
    ...
    api.add_namespace(volunteer_ns)
    api.add_namespace(fundraising_ns)
